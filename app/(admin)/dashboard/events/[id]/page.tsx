...
export default function EventDetailsPage() {
  ...
  if (loading) {
    return <p className="text-center text-muted-foreground mt-10">Loading event...</p>;
  }
  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-2xl mx-auto space-y-5">
      ...
      <DatePicker value={selectedDate} onChange={handleDateChange} className="w-full" />
      ...
      <div className="space-y-2">
        ...
        {form.image && (
          <div className="relative mt-2 border rounded-lg overflow-hidden">
            <Image src={form.image} alt="Event Image" width={800} height={400} className="object-cover w-full h-56" />

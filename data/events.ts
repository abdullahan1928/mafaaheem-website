export const eventsContent = {
  ...
  ur: {
    ...
    description:
      "سیکھنے، غور و فکر اور تعلق کو فروغ دینے کے لیے منعقد کیے جانے والے پروگراموں، ورکشاپس اور روحانی اجتماعات کا مجموعہ۔",
  ...
  ar: {
    ...
    description:
      "مجموعة من البرامج وورش العمل والتجمعات الروحية المخصصة للتعلم والتأمل والتواصل.",
